...
export default class Visual extends WynVisual {
  ...
  constructor(dom: HTMLDivElement, host: VisualNS.VisualHost, options: VisualNS.IVisualUpdateOptions) {
    ...
    this.container = dom;
    echarts = host.moduleManager.getModule('echarts');
    ...
    const lodash = host.moduleManager.getModule('lodash');
    this.myTooltip = new myTooltipC(dom, this.config, lodash);
  ...
  private render(allowAnimation = true) {
  ...
  public export() {
    ...
    this.chart.on('finished', () => {
      def.resolve(this.chart.getDataURL({ type: 'png' }));
