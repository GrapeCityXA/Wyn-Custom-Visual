...
export default class Visual extends WynVisual {
  ...
  constructor(dom: HTMLDivElement, host: VisualNS.VisualHost, options: VisualNS.IVisualUpdateOptions) {
    ...
    this.echarts=host.moduleManager.getModule('echarts').init(dom);
    this.dom = dom;
    ...
    this.dom.addEventListener('click', this.clickFunction1 );
  ...
  public onDestroy(): void {
    this.dom.removeEventListener('click', this.clickFunction1 )
  ...
  public export() {
    return this.echarts.getDataURL({ type: 'png' });
  }
}